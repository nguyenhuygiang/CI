<html>
    <head>
        ...
        <script src="<?php echo base_url('js/ajax_login.js'); ?>" type="text/javascript"></script>
    <body>
        <div class="container" id="login_form">
            <section id="content">
                <form id="login_form" action="<?php echo site_url('ajax_login/check_login') ?>" method="post" >
                    <h1>Login Form</h1>
                    <div>
